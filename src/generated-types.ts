...
export type HealthHubServiceInput = {
  ...
  name: Scalars['String'];
  price?: Maybe<Scalars['Float']>;
  guideline?: Maybe<GuidelineInput>;
...
export type ProvidersPartFragment = { __typename?: 'Provider' } & Pick<
  Provider,
  | 'startHour'
  | 'endHour'
  | 'startIntervalHour'
...
export type ProviderQuery = { __typename?: 'Query' } & {
  provider: { __typename?: 'Provider' } & ProvidersPartFragment;
};
...
export type CreateProviderMutation = { __typename?: 'Mutation' } & {
  createProvider?: Maybe<{ __typename?: 'Provider' } & ProvidersPartFragment>;
};
...
export type UpdateProviderMutation = { __typename?: 'Mutation' } & {
  updateProvider?: Maybe<{ __typename?: 'Provider' } & ProvidersPartFragment>;
};
...
export type SellerPartsFragment = { __typename?: 'Seller' } & Pick<
  ...
  | 'tradingName'
> & {
    address: { __typename?: 'SellerAddress' } & Pick<
      SellerAddress,
      'zipCode' | 'city' | 'neighborhood' | 'country' | 'state' | 'street' | 'number'
    >;
    services?: Maybe<
      Array<
        { __typename?: 'SellerService' } & Pick<
          SellerService,
          'id' | 'name' | 'type' | 'price' | 'info'
        >
      >
    >;
  };
...
export type SellerQuery = { __typename?: 'Query' } & {
  seller: { __typename?: 'Seller' } & SellerPartsFragment;
};
...
export type SellersQuery = { __typename?: 'Query' } & {
  sellers: { __typename?: 'SellersAll' } & Pick<
    SellersAll,
    'page' | 'totalPages' | 'totalElements'
  > & { content: Array<{ __typename?: 'Seller' } & SellerPartsFragment> };
};
...
export type CreateSellerMutation = { __typename?: 'Mutation' } & {
  createSeller?: Maybe<{ __typename?: 'Seller' } & SellerPartsFragment>;
};
...
export type UpdateSellerMutation = { __typename?: 'Mutation' } & {
  updateSeller?: Maybe<{ __typename?: 'Seller' } & SellerPartsFragment>;
};
...
> & {
    guideline?: Maybe<
      { __typename?: 'Guideline' } & Pick<Guideline, 'howTo' | 'attentionPoints'>
    >;
    procedureFields: Array<
      { __typename?: 'HealthHubServiceField' } & Pick<
        HealthHubServiceField,
        'key' | 'label' | 'type' | 'position'
      > & {
          validations?: Maybe<
...
export type ServiceQuery = { __typename?: 'Query' } & {
  service?: Maybe<
    { __typename?: 'HealthHubServiceById' } & Pick<
    ...
    > & {
        ...
        >;
        procedureFields: Array<
          { __typename?: 'HealthHubServiceFieldById' } & Pick<
          ...
          > & {
              ...
              values?: Maybe<
                Array<
                  { __typename?: 'HealthHubServiceValueById' } & Pick<
...
export type CreateServiceMutation = { __typename?: 'Mutation' } & {
  createService?: Maybe<{ __typename?: 'HealthHubService' } & ServicePartsFragment>;
};

export type UserPartsFragment = { __typename?: 'User' } & Pick<
  User,
  'id' | 'name' | 'email' | 'profile' | 'partnerId' | 'disabled'
> & { roles: Array<Maybe<{ __typename?: 'Role' } & Pick<Role, 'name' | 'description'>>> };
...
export type GetUserByIdQuery = { __typename?: 'Query' } & {
  getUserById?: Maybe<{ __typename?: 'User' } & UserPartsFragment>;
};
...
export type GetAllUsersQuery = { __typename?: 'Query' } & {
  getAllUsers: { __typename?: 'UsersAll' } & Pick<
    UsersAll,
    'page' | 'totalPages' | 'totalElements'
  > & { content: Array<{ __typename?: 'User' } & UserPartsFragment> };
};
...
export type CreateUserMutation = { __typename?: 'Mutation' } & {
  createUser?: Maybe<{ __typename?: 'User' } & UserPartsFragment>;
};
...
export type UpdateUserMutation = { __typename?: 'Mutation' } & {
  updateUser?: Maybe<{ __typename?: 'User' } & UserPartsFragment>;
};
...
export function useProviderQuery(
  baseOptions: Apollo.QueryHookOptions<ProviderQuery, ProviderQueryVariables>
) {
  return Apollo.useQuery<ProviderQuery, ProviderQueryVariables>(
    ProviderDocument,
    baseOptions
  );
}
export function useProviderLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProviderQuery, ProviderQueryVariables>
) {
  return Apollo.useLazyQuery<ProviderQuery, ProviderQueryVariables>(
    ProviderDocument,
    baseOptions
  );
}
...
export type ProviderQueryResult = Apollo.QueryResult<
  ProviderQuery,
...
export function useSellersQuery(
  baseOptions?: Apollo.QueryHookOptions<SellersQuery, SellersQueryVariables>
) {
  return Apollo.useQuery<SellersQuery, SellersQueryVariables>(
    SellersDocument,
    baseOptions
  );
}
export function useSellersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<SellersQuery, SellersQueryVariables>
) {
  return Apollo.useLazyQuery<SellersQuery, SellersQueryVariables>(
    SellersDocument,
    baseOptions
  );
}
...
export function useCreateSellerMutation(
  ...
  return Apollo.useMutation<CreateSellerMutation, CreateSellerMutationVariables>(
...
export const UpdateSellerDocument = gql`
  ...
  ${SellerPartsFragmentDoc}
`;
export type UpdateSellerMutationFn = Apollo.MutationFunction<
...
export function useUpdateSellerMutation(
  ...
  return Apollo.useMutation<UpdateSellerMutation, UpdateSellerMutationVariables>(
...
export type UpdateSellerMutationOptions = Apollo.BaseMutationOptions<
  UpdateSellerMutation,
  UpdateSellerMutationVariables
>;
